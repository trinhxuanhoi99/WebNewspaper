...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <form action="{{route('postThemTT')}}" method="POST">
                {{csrf_field()}}
                <label>Tiêu đề</label>
                <input type="text" id="fname" name="TieuDe" placeholder="Tiêu đề">
                <label>Nội Dung Tóm Tắt</label>
                <textarea class="form-control" rows="3" name="TomTat" placeholder="Tóm Tắt"></textarea>
                <label>Nội Dung</label>
                <textarea class="form-control" name="NoiDung" id="" rows="3" placeholder="Nội Dung"></textarea>
                ...
                <button type="submit" class="button btn btn-home-newsletter " data-index="0">Thêm Tin Tức</button>
